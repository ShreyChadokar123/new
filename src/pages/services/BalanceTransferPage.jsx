...
const testimonials = [
  {
    ...
    quote: "I transferred my home loan and saved a lot on interest. The process was smooth and quick!",
    rating: 5,
  ...
  },
  {
    name: "Priya Patel",
    position: "Teacher",
    quote: "Balance transfer with Hously Finserv was hassle-free. Got lower EMI and better service.",
    rating: 5,
  ...
  },
  {
    ...
    quote: "Best rates for balance transfer. The team handled everything professionally.",
    rating: 4,
...
const features = [
  "Lowest balance transfer rates from 8.00%",
...
const eligibility = [
  "Existing home/property loan with 12+ EMIs paid",
...
const BalanceTransferPage = () => {
  ...
  return (
    <Layout>
      ...
      <div className="relative h-[400px] md:h-[520px] flex items-center justify-center overflow-hidden mb-10 md:mb-16">
        ...
        <div className="relative z-20 text-white text-center flex flex-col items-center px-4">
          <h1 className="text-4xl md:text-6xl font-extrabold mb-4 drop-shadow-lg">
            Transfer Your Loan, Save Big!
          </h1>
          <p className="text-lg md:text-2xl font-medium mb-8 drop-shadow">
            Lower your EMIs. Get top-up. Fastest balance transfer from top banks.
          </p>
          {/* HERO BUTTONS */}
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 max-w-xl mx-auto">
          {!leadSubmitted ? (
            ...
            <div className="text-center">
              ...
              <div className="mb-4">Your details have been submitted.<br />Our expert will contact you soon with the best balance transfer offers.</div>
              <Button
                className="bg-blue-600 text-white px-6 py-2 rounded font-bold shadow hover:bg-blue-700 transition"
      ...
      {/* Compare Top Banks for Balance Transfer (table section) */}
      <div id="banks" className="container mx-auto mb-10 md:mb-16 mt-10 md:mt-16">
        <h2
          className="text-2xl font-bold mb-6 text-center"
          style={{ color: "#0074d9" }}
        >
          Compare Top Banks for Balance Transfer
        </h2>

    ...
    <Layout>
      ...
      <section className="relative bg-gradient-to-r from-[#0045a8] to-[#00a9e0] text-white py-10 sm:py-14 text-center px-2 sm:px-4 font-sans overflow-hidden">
        <div className="w-4/5 mx-auto md:w-full md:max-w-2xl text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold leading-tight mb-2 tracking-tight">
            State Bank of  <span style={{ color: "#FFD700" }}>India Loans</span>
          </h1>
          <p className="mt-2 text-base sm:text-lg font-medium text-blue-100">
            Trusted Home, Personal, and Car Loans with competitive rates, flexible tenures, and fast digital approval from India's largest bank.
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 w-4/5 mx-auto md:w-full">
          ...
          <div className="w-4/5 mx-auto md:w-full bg-white rounded-lg shadow p-4 sm:p-6 border">
            ...
            <p className="text-gray-700 mb-2">
              Interest rates from 8.50% p.a., up to 90% of property value, tenure up to 30 years, and zero foreclosure charges.
            </p>
            <ul className="text-sm text-gray-600 mb-2 list-disc ml-4">
              <li>Loan up to 90% of property value</li>
              <li>Interest rates: 8.50% – 10.15% p.a.</li>
              <li>Tenure: Up to 30 years</li>
              <li>No foreclosure charges</li>
            </ul>
            <a
              href="https://homeloans.sbi/calculators/home-loan-emi-calculator"
              target="_blank"
          ...
          <div className="w-4/5 mx-auto md:w-full bg-white rounded-lg shadow p-4 sm:p-6 border">
            ...
            <p className="text-gray-700 mb-2">
              Quick approval, minimal documentation, and attractive rates from 10.30% p.a. for amounts up to ₹35 lakh.
            </p>
            <ul className="text-sm text-gray-600 mb-2 list-disc ml-4">
              <li>Loan from ₹50,000 to ₹35 lakh</li>
              <li>Tenure: 1 to 6 years</li>
              <li>Interest rates: 10.30% – 15.30% p.a.</li>
              <li>Instant online application</li>
            </ul>
            <a
              href="https://onlineapply.sbi.co.in/personal-banking/personal-loan-emi-calculator"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block mt-2 text-[#0045a8] hover:underline font-semibold"
            >
          ...
          <div className="w-4/5 mx-auto md:w-full bg-white rounded-lg shadow p-4 sm:p-6 border">
            ...
            <p className="text-gray-700 mb-2">
              Up to 90% on-road funding, flexible tenure up to 7 years, and quick approval for your new or used car.
            </p>
            <ul className="text-sm text-gray-600 mb-2 list-disc ml-4">
              <li>Loan up to 90% of on-road price</li>
              <li>Tenure: Up to 7 years</li>
              <li>Attractive interest rates</li>
            </ul>
            <a
              href="https://onlineapply.sbi.co.in/personal-banking/car-loan-emi-calculator"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block mt-2 text-[#0045a8] hover:underline font-semibold"
            >
      ...
      <section className="bg-blue-50 py-8 sm:py-10 px-2 sm:px-4">
        <div className="w-4/5 mx-auto md:w-full md:max-w-3xl">
          <h2 className="text-lg sm:text-xl font-bold text-[#0045a8] mb-3 sm:mb-4">How does the SBI EMI Calculator work?</h2>
          <p className="text-gray-700 mb-3 sm:mb-4 text-sm sm:text-base">
            SBI’s EMI calculators help you instantly estimate your monthly repayments based on loan amount, interest rate, and tenure. Just enter your values and get your EMI—no complex math required!
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 w-4/5 mx-auto md:w-full">
          ...
          <div className="flex flex-col items-center justify-center ">
            <div className="bg-gradient-to-br from-[#FFD700] to-[#fffbe6] rounded-2xl shadow-lg p-4 sm:p-6 border border-yellow-200 w-4/5 mx-auto md:max-w-xs text-center">
              <div className="text-base sm:text-lg font-bold mb-2 sm:mb-3 text-[#0045a8]">Why SBI?</div>
              ...
              <a
                href="https://onlineapply.sbi.co.in/personal-banking/home"
                target="_blank"
                rel="noopener noreferrer"

    ...
    <Layout>
      ...
      <section className="relative bg-gradient-to-r from-[#0045a8] to-[#00a9e0] text-white py-10 sm:py-14 text-center px-2 sm:px-4 font-sans overflow-hidden">
        <div className="w-4/5 mx-auto md:w-full md:max-w-2xl text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold leading-tight mb-2 tracking-tight">
            HDFC Bank <span style={{ color: "#FFD700" }}>Loans</span>
          </h1>
          <p className="mt-2 text-base sm:text-lg font-medium text-blue-100">
            India's leading bank for Home, Personal, and Car Loans with attractive rates and instant approval.
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 w-4/5 mx-auto md:w-full">
          ...
          <div className="w-4/5 mx-auto md:w-full bg-white rounded-lg shadow p-4 sm:p-6 border">
            ...
            <p className="text-gray-700 mb-2">
              Attractive interest rates, flexible tenure up to 30 years, and quick processing.
            </p>
            <ul className="text-sm text-gray-600 mb-2 list-disc ml-4">
              <li>EMIs from ₹765 per lakh*</li>
              <li>Loan up to 90% of property value</li>
              <li>Easy balance transfer</li>
            </ul>
            <a
              href="https://www.hdfcbank.com/personal/tools-and-calculators/home-loan-emi-calculator"
              target="_blank"
          ...
          <div className="w-4/5 mx-auto md:w-full bg-white rounded-lg shadow p-4 sm:p-6 border">
            ...
            <p className="text-gray-700 mb-2">
              Get instant approval, minimal documentation, and pocket-friendly EMIs.
            </p>
            <ul className="text-sm text-gray-600 mb-2 list-disc ml-4">
              <li>Loan from ₹50,000 to ₹40 lakh</li>
              <li>Tenure: 1 to 5 years</li>
              <li>Disbursal in 10 seconds*</li>
            </ul>
            <a
              href="https://www.hdfcbank.com/personal/tools-and-calculators/personal-loan-calculator"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block mt-2 text-[#0045a8] hover:underline font-semibold"
            >
          ...
          <div className="w-4/5 mx-auto md:w-full bg-white rounded-lg shadow p-4 sm:p-6 border">
            ...
            <p className="text-gray-700 mb-2">
              Finance your dream car with easy EMIs and up to 100% on-road funding.
            </p>
            <ul className="text-sm text-gray-600 mb-2 list-disc ml-4">
              <li>Flexible tenure: 1 to 8 years</li>
              <li>Quick approval & minimal paperwork</li>
              <li>Attractive interest rates</li>
            </ul>
            <a
              href="https://www.hdfcbank.com/personal/tools-and-calculators/car-loan-emi-calculator"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block mt-2 text-[#0045a8] hover:underline font-semibold"
            >
      ...
      <section className="bg-blue-50 py-8 sm:py-10 px-2 sm:px-4">
        <div className="w-4/5 mx-auto md:w-full md:max-w-3xl">
          <h2 className="text-lg sm:text-xl font-bold text-[#0045a8] mb-3 sm:mb-4">How does the HDFC Bank EMI Calculator work?</h2>
          <p className="text-gray-700 mb-3 sm:mb-4 text-sm sm:text-base">
            HDFC Bank's EMI calculators for home, personal, and car loans help you plan your repayment by instantly showing your monthly EMI based on loan amount, interest rate, and tenure. Just enter the values and get your EMI—no complex formulas needed!
          </p>
      ...
      {/* Why Choose HDFC Bank Section */}
      <section className="container mx-auto py-8 sm:py-10 px-2 sm:px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 w-4/5 mx-auto md:w-full">
          {/* Why Choose HDFC Bank? (left) */}
          <div className="flex flex-col justify-center md:ml-40">
            <div className="text-lg sm:text-xl font-bold text-[#0045a8] mb-3 sm:mb-4">Why Choose HDFC Bank?</div>
            <ul className="list-disc ml-5 sm:ml-6 text-gray-700 space-y-1 sm:space-y-2 text-sm sm:text-base">
              <li>Pocket-friendly EMIs and attractive interest rates</li>
              <li>Flexible loan tenures and quick disbursal</li>
              <li>Maximum loan eligibility in 1 minute</li>
              <li>Trusted by millions for over 25 years</li>
              <li>Online application and instant approval for select customers*</li>
            </ul>
            <div className="text-xs text-gray-500 mt-3 sm:mt-4">*Terms and conditions apply</div>
          </div>
          {/* Why HDFC Bank (right, short box) */}
          <div className="flex flex-col items-center justify-center ">
            <div className="bg-gradient-to-br from-[#FFD700] to-[#fffbe6] rounded-2xl shadow-lg p-4 sm:p-6 border border-yellow-200 w-4/5 mx-auto md:max-w-xs text-center">
              <div className="text-base sm:text-lg font-bold mb-2 sm:mb-3 text-[#0045a8]">Why HDFC Bank?</div>
              <ul className="text-xs sm:text-sm text-gray-700 mb-3 sm:mb-4 text-left list-disc ml-3 sm:ml-4">
                ...
                <li>Lowest EMI offers</li>
                <li>24x7 customer support</li>
              </ul>
              <a
                href="https://apply.hdfcbank.com/"
                target="_blank"
                rel="noopener noreferrer"

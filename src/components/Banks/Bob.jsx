    ...
    <Layout>
      ...
      <section className="relative bg-gradient-to-r from-[#0045a8] to-[#00a9e0] text-white py-10 sm:py-14 text-center px-2 sm:px-4 font-sans overflow-hidden">
        <div className="w-4/5 mx-auto md:w-full md:max-w-2xl text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold leading-tight mb-2 tracking-tight">
            Bank of  <span style={{ color: "#FFD700" }}>Baroda Loans</span>
          </h1>
          <p className="mt-2 text-base sm:text-lg font-medium text-blue-100">
            Secure Home, Personal, and Car Loans with attractive rates, flexible tenures, and fast digital approval from one of India's most trusted banks.
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 w-4/5 mx-auto md:w-full">
          ...
          <div className="w-4/5 mx-auto md:w-full bg-white rounded-lg shadow p-4 sm:p-6 border">
            ...
            <p className="text-gray-700 mb-2">
              Interest rates from 8.40% p.a., tenure up to 30 years, and easy balance transfer for buying, building, or improving your home.
            </p>
            ...
            <a
              href="https://www.bankofbaroda.in/personal-banking/loans/home-loan/baroda-home-loan"
              target="_blank"
          ...
          <div className="w-4/5 mx-auto md:w-full bg-white rounded-lg shadow p-4 sm:p-6 border">
            ...
            <p className="text-gray-700 mb-2">
              Instant approval, minimal documentation, and attractive rates starting from 11.15% p.a. for amounts up to ₹20 lakh.
            </p>
            <ul className="text-sm text-gray-600 mb-2 list-disc ml-4">
              <li>Loan from ₹50,000 to ₹20 lakh</li>
              <li>Tenure: up to 7 years</li>
              <li>Quick online application</li>
            </ul>
            <a
              href="https://www.bankofbaroda.in/personal-banking/loans/personal-loan/baroda-personal-loan"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block mt-2 text-[#0045a8] hover:underline font-semibold"
            >
          ...
          <div className="w-4/5 mx-auto md:w-full bg-white rounded-lg shadow p-4 sm:p-6 border">
            ...
            <p className="text-gray-700 mb-2">
              Up to 90% on-road funding, competitive interest rates, and flexible repayment for new or used cars.
            </p>
            <ul className="text-sm text-gray-600 mb-2 list-disc ml-4">
            ...
            <a
              href="https://www.bankofbaroda.in/personal-banking/loans/vehicle-loan"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block mt-2 text-[#0045a8] hover:underline font-semibold"
            >
      ...
      <section className="bg-blue-50 py-8 sm:py-10 px-2 sm:px-4">
        <div className="w-4/5 mx-auto md:w-full md:max-w-3xl">
          <h2 className="text-lg sm:text-xl font-bold text-[#0045a8] mb-3 sm:mb-4">How does the Bank of Baroda EMI Calculator work?</h2>
          <p className="text-gray-700 mb-3 sm:mb-4 text-sm sm:text-base">
            Bank of Baroda’s EMI calculators help you instantly estimate your monthly repayments based on loan amount, interest rate, and tenure. Just enter your values and get your EMI—no complex math required!
          </p>
      ...
      <section className="container mx-auto py-8 sm:py-10 px-2 sm:px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 w-4/5 mx-auto md:w-full">
          ...
          {/* Why Bank of Baroda (right, short box) */}
          <div className="flex flex-col items-center justify-center ">
            <div className="bg-gradient-to-br from-[#FFD700] to-[#fffbe6] rounded-2xl shadow-lg p-4 sm:p-6 border border-yellow-200 w-4/5 mx-auto md:max-w-xs text-center">
              <div className="text-base sm:text-lg font-bold mb-2 sm:mb-3 text-[#0045a8]">Why Bank of Baroda?</div>
              ...
              <a
                href="https://www.bankofbaroda.in/personal-banking/loans"
                target="_blank"
                rel="noopener noreferrer"

    ...
    <Layout>
      ...
      <section className="relative bg-gradient-to-r from-[#0045a8] to-[#00a9e0] text-white py-10 sm:py-14 text-center px-2 sm:px-4 font-sans overflow-hidden">
        <div className="w-4/5 mx-auto md:w-full md:max-w-2xl text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold leading-tight mb-2 tracking-tight">
            ICICI Bank <span style={{ color: "#FFD700" }}>Loans</span>
          </h1>
          <p className="mt-2 text-base sm:text-lg font-medium text-blue-100">
            Easy Home, Personal, and Car Loans with fast approval, minimal paperwork, and attractive rates—empowering your dreams.
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 w-4/5 mx-auto md:w-full">
          ...
          <div className="w-4/5 mx-auto md:w-full bg-white rounded-lg shadow p-4 sm:p-6 border">
            ...
            <p className="text-gray-700 mb-2">
              Up to ₹5 crore, minimal documentation, instant sanction, flexible tenure, and no foreclosure charges.
            </p>
            <ul className="text-sm text-gray-600 mb-2 list-disc ml-4">
              <li>Loan up to ₹5 crore</li>
              <li>Flexible tenure up to 30 years</li>
              <li>Instant provisional sanction*</li>
            </ul>
            <a
              href="https://www.icicibank.com/personal-banking/loans/home-loan"
              target="_blank"
          ...
          <div className="w-4/5 mx-auto md:w-full bg-white rounded-lg shadow p-4 sm:p-6 border">
            ...
            <p className="text-gray-700 mb-2">
              Instant approval, negligible documentation, multipurpose usage, and attractive interest rates.
            </p>
            <ul className="text-sm text-gray-600 mb-2 list-disc ml-4">
              <li>Loan up to ₹50 lakh</li>
              <li>Tenure: 1 to 6 years</li>
              <li>Quick disbursal in seconds*</li>
            </ul>
            <a
          ...
          <div className="w-4/5 mx-auto md:w-full bg-white rounded-lg shadow p-4 sm:p-6 border">
            ...
            <p className="text-gray-700 mb-2">
              Up to 100% on-road funding, quick online process, and flexible repayment options.
            </p>
            <ul className="text-sm text-gray-600 mb-2 list-disc ml-4">
              <li>Loan up to 100% of on-road price</li>
      ...
      <section className="bg-blue-50 py-8 sm:py-10 px-2 sm:px-4">
        <div className="w-4/5 mx-auto md:w-full md:max-w-3xl">
          <h2 className="text-lg sm:text-xl font-bold text-[#0045a8] mb-3 sm:mb-4">How does the ICICI Bank EMI Calculator work?</h2>
          <p className="text-gray-700 mb-3 sm:mb-4 text-sm sm:text-base">
            ICICI Bank’s EMI calculators help you instantly estimate your monthly repayments based on loan amount, interest rate, and tenure. Just enter your values and get your EMI—no complex math required!
          </p>
      ...
      {/* Why Choose ICICI Bank Section */}
      <section className="container mx-auto py-8 sm:py-10 px-2 sm:px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 w-4/5 mx-auto md:w-full">
          {/* Why Choose ICICI Bank? (left) */}
          <div className="flex flex-col justify-center md:ml-40">
            <div className="text-lg sm:text-xl font-bold text-[#0045a8] mb-3 sm:mb-4">Why Choose ICICI Bank?</div>
          ...
          <div className="flex flex-col items-center justify-center ">
            <div className="bg-gradient-to-br from-[#FFD700] to-[#fffbe6] rounded-2xl shadow-lg p-4 sm:p-6 border border-yellow-200 w-4/5 mx-auto md:max-w-xs text-center">
              <div className="text-base sm:text-lg font-bold mb-2 sm:mb-3 text-[#0045a8]">Why ICICI Bank?</div>
              ...
              <a
                href="https://www.icicibank.com/personal-banking/loans"
                target="_blank"
                rel="noopener noreferrer"
